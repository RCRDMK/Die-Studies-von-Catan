...
public interface AISystem {
    ...
    /**
     * Method used to start the turn of the AI. This method is called by the server to engage the AI to start it's turn.
     *
    ...
    /**
     * Method used to continue the turn of the AI. This method is called by the server to re-engage the AI to continue it's turn after it stopped because
